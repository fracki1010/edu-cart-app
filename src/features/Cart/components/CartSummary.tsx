...
export const CartSummary: React.FC<CartSummaryProps> = ({
  ...
  const handleCheckout = () => {
    ...
    // VALIDACIÓN DE FLUJO:
    // Si el usuario existe, vamos al checkout.
    // Si NO existe, intentamos ir al checkout igual.
    // ¿Por qué? Porque tu Router tiene una "Ruta Protegida" en /checkout.
    // El Router se encargará de detectar que no hay token y redirigir a /login.
    navigate("/checkout");
  };
